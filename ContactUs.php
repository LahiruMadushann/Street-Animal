    ...
    <div class="col-md">
      <div class="card text-dark bg-white mb-3 shadow-crd shadow p-3" >
        ...
        <div class="card-body">
          ...
          <p>Do you have any questions about BE A HOME? We definitely have the answer.</p>
