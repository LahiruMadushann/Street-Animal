...
<nav class="navbar navbar-expand shadow p-3 mb-5 bg-white rounded "  >
    ...
    <div style="width: 100vw;height: 27vw;background-color:#e0e6eb;margin-top:1vw" class="MainImage d-sm-flex align-items-center ">
      <img src="HomePageIMG/cat.png" alt="New York" class="d-block" style="width: 25vw;height: 25vw;margin-left:36vw;margin-top:1vw;float:left" >
      <h3 style="font-size:3vw;margin-left:-7vw;font-weight:bold;">Cats</h3>
    </div>

    <section style="margin-top:32%">    
        <?php
       
       
        $query="SELECT * FROM `animal_detail` WHERE `animal_category`= 'Cat' AND `status`='activated'";
                  ...
                  ?>
                      ...
                      <div style="margin-left:7.5vw;margin-right:2vw;margin-bottom:0%">
                        <table class="pic cardImage  " style="margin:2%;height:20vw;width:18vw">
                          ...
                          <tr>
                            <td class="" style="margin-left:33%">Animal ID : <?php echo $row['animal_id']; ?></td>
                          </tr>
                          <tr>
