...
<body style="background-color: ghostwhite;">
  ...
  <div class="ms-5 " >
    <h1 class="text-center ourPurpose text-secondary" style="font-size:2vw">ABOUT BE A HOME</h1>
    ...
    <div class="container bg-ghoustwhite" >
        ...
        <div class="card text-dark bg-white mb-3 shadow-crd shadow p-3  " >
          ...
          <img src="./about/AboutBeAHome.jpg" class="card-img-top " alt="service" style="width:36vw;height:33vw;margin-right:2vw">
        </div>
            <h5 class="card-title" style="font-size:2vw">Our Story</h5>
          <div style="font-size:1.1vw">
            <p> Be A Home was started in 2022 thanks to the growing demand for a positive reinforcement animal care. We met many paw-parents were looking for a animal care committed to safety, fun, cleanliness, open communication and positive reinforcement.

              Until now, these remain our core values. In our early years, our animal care program focused mainly on socialization and physical exercise. We have monitored playgroups, outings, walks and dog parks to burn off all that excess energy. As our knowledge of dogs grew, we designed a new curriculum that included enrichment activities so that our dogs can fulfill their need to forage, touch, solve problems and do things dogs love to do.

              Our relationship with the dogs and their owners is something that we treasure.</p>
              
            <p>  We update our owners everyday at the same time, because we know owners want to know what’s going on. We also hope to teach owners a little something they didn’t know before about their dogs through our activities and updates.

              I’m proud of our team and our accomplishments as a trusted daycare provider. We’ve been able to give back to our community through Food Drives for shelters and doggy visits to seniors homes. Come join us at our one of a kind dog daycare.

              Sincerely,
              Hurb

              Co-founder of Be A Home </p>
          </div>
        ...
        <div class="card text-dark bg-white mb-3 shadow-crd shadow p-3  " >
          ...
          <div class="card-body">
            ...
            <div style="float:left">
          <img src="./about/mission.png" class="card-img-top " alt="service" style="width:36vw;height:33vw;margin-right:2vw">
        </div>
                    <h5 class="card-title" style="font-size:2vw">Our Mission</h5>
                  <div style="font-size:1.1vw">
                    <p> Our mission is to save the lives of the homeless and unwanted companion animals of Singapore.</p>
                    <p>To employ programs and policies to promote best practice, ethical, sustainable and compassionate treatment of these animals.</p>
                    
                    <p>To treat all living things as we ourselves would wish to be treated.</p>
                    <p>To demonstrate compassion and respect for all living creatures.</p>
                    ...
                    <p>To lead by example, developing, promoting and sharing great new ideas and programs to help animals.</p>
                  </div>
          </div>
        </div>
