...
<nav class="navbar navbar-expand shadow p-3 mb-5 bg-white rounded "  >
    ...
    <div style="width: 100vw;height: 27vw;background-color:#ffd24d;margin-top:1vw" class="MainImage d-sm-flex align-items-center ">
      <img src="HomePageIMG/dog.png" alt="New York" class="d-block" style="width: 30vw;height: 30vw;margin-left:34vw;margin-top:-3.1vw" >
      <h3 style="font-size:3vw;margin-left:-5vw;font-weight:bold;">Dogs</h3>
    ...
    <section style="margin-top:32%">    
        ...
        $query="SELECT * FROM `animal_detail` WHERE `animal_category`= 'Dog' AND `status`='activated'";
