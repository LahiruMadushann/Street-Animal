...
<div class="container" style="height:3rem">
        ...
        <div class="container text-center mt-3">
            <h1 class="text-secondary">Kind Person Detail</h1>
          </div>
          
            <div class="container mt-3 mb-5 shadow" style="width:800px;">
            <form action="AddGetData.php?id=<?php echo $animal_id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <label style="color:#ff0000;" for="regdate" class="form-label"><?php echo date('Y-m-d');  ?> </label>
                      ...
                      <div class="mb-3">
                        <label for="firstname" class="form-label" style="margin-top:4%;">First Name</label>
                        <input class="form-control" id="name" aria-describedby="name" type="text" name="firstname" value="<?php print $u_fname; ?>" required >
                      </div>

                      <div class="mb-3">
                        <label for="lastname" class="form-label">Last Name</label>
                        <input class="form-control" id="lastname" aria-describedby="lastname" type="text" name="lastname" value="<?php echo $u_lname; ?>" required >
                      </div>
                      ...
                      <select class="form-select " name="district" >
                          ...
                          <option value="Galle">Galle</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control" value="<?php echo $u_email;?>" required READONLY>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="animalCategory" aria-describedby="animalCategory"  name="animalCategory" value="<?php echo $animal_category; ?>" required READONLY>
                    </div>

                 
                    <div class="mb-3">

                        <label for="district" class="form-label">When You Come To Get Puppy :</label>
                        <input type="date" class="form-control" aria-describedby="district" id="district" name="getDate" required>
                        </div>
