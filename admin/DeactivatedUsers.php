            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Deactivated Users</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            //   $query2="SELECT * FROM `userdetail`";
                              ...
                              WHERE user_login.status='notverified'";
                              ...
                              <tr>
                                  ...
                                  <!-- <td></td> -->
                                  <td>
                                  <a class="btn btn-primary" href="ActivateUserStatus.php?user_id=<?php echo $u_id; ?>">Activate </a>
                                  </td>
