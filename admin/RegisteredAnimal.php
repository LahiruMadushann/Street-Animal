                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Registered Animals</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                              ...
                              $query2="SELECT * FROM `animal_detail` WHERE status='activated'";
                              ...
                              <tr>
                                  ...
                                  <a class="btn btn-primary" href="updateAnimalStatus.php?animal_id=<?php echo $a_id; ?>"> Deactivate </a>
                                  </td>
                                  <td>
                                  <a class="btn btn-primary" href="animalRemove.php?animal_id=<?php echo $a_id; ?>"> Remove </a>
