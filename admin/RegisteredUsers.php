                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            //   $query2="SELECT * FROM `userdetail`";
                              $query3=" SELECT user_login.*, userdetail.*   
                              FROM userdetail  
                              INNER JOIN user_login  
                              ON userdetail.user_id = user_login.user_id  
                              WHERE user_login.status='verified'";
                              ...
                              <tr>
                                  ...
                                  <!-- <td></td> -->
                                  <td>
                                  <a class="btn btn-primary" href="updateUserStatus.php?user_id=<?php echo $u_id; ?>"> Deactivate </a>
                                  </td>
                                  <td>
                                  <a class="btn btn-primary" href="userRemove.php?user_id=<?php echo $u_id; ?>"> Remove </a>
